...
<div class="form-group col-sm-6">
    {!! Form::label('customer_id', 'Pembeli :') !!}
...
<div class="form-group col-md-12">
 ...
 <div class="form-group col-md-12">
    <h4><center>Daftar Penjualan</center></h4>
    <div class="row" style="border-bottom: 1px solid #eeeeee;margin-bottom: 15px;padding-bottom: 5px;">
        <div class="col-md-1"><center>No</center></div>
        <div class="col-md-2"><center>Produk</center></div>
        <div class="col-md-3"><center>Harga</center></div>
        <div class="col-md-3"><center>Jumlah</center></div>
        <div class="col-md-3"><center>Total</center></div>
    </div>
